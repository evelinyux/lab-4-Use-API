...
public class Application {
    ...
    // added GetTopGradeUseCase parameter, added new instance variable and updated call site in main.
    private static JPanel createManageTeamCard(JFrame jFrame, LeaveTeamUseCase leaveTeamUseCase,
        ...
        // Action listener for getTopGrade button
        ...
        theCard.add(new JLabel("The course you want to calculate the team average and top grade for:"));
